...
class TestAddCompany():
    ...
    def test_add_nullname(self):
        ...
        assert self.toast.page_toast() == companyName[0]['except_result']
    # 添加公司，默认行业
    def test_default_vocation(self):
        ...
        assert self.add.companyName() == companyName[1]['except_result']
    # 添加公司，选择教育培训行业
    def test_select_education(self):
        ...
        assert self.add.companyName() == companyName[2]['except_result']
    #添加公司，选择水利水电行业
    def test_select_waterboard(self):
        ...
        assert self.add.companyName() == companyName[3]['except_result']
    #添加已存在的公司
    def test_exist_company(self):
        ...
        assert self.toast.sever_toast() == companyName[4]['except_result']
    ...
    def test_attestation_company(self):
        ...
        assert self.toast.sever_toast() == companyName[5]['except_result']
        self.add.cancel_add_company()
    # 新账号首次添加公司
    ...
    #     assert self.add.companyName() ==  companyName[7]['except_result']
if __name__ == '__main__':
    pytest.main(["-s","test_AddCompanySuitePytest.py"])
